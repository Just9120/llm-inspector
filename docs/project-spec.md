...
- Last recalculation: `2026-09-04T05:12:11Z`.
...
- Full agreed roadmap readiness on exact merged main: `152/164 = 92.7%`; B02 remains `IN PROGRESS` despite `9/9` until required LIVE Evidence, and hotfix adds no AC.
