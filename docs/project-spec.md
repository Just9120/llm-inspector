...
| **Initial release total** | **🟦 IN PROGRESS** | **72/139** | **51.8%** | **◐** | **◐** | **◐** | **◐** | **N/A** | **N/A** |
...
| **Full agreed roadmap total** | **🟦 IN PROGRESS** | **72/164** | **43.9%** | **◐** | **◐** | **◐** | **◐** | **—*** | **—*** |
...
- Code/tests/runtime: loopback streaming gateway, versioned backend adapters including LM Studio native v1, privacy-safe observation/correlation contract, live/token/context/timing UI и SQLite schema v2 history/analytics/retention. Focused Release build completed with zero warnings/errors; Integration `36/36`, Unit `34/34`, Privacy `5/5` and Windows `29/29` passed. Full local CI-equivalent is the next gate.
