...
export const labels = {
  ...
  verified: 'Проверено (версия и Evidence — в подробностях)',
  compatible: 'Совместимо; ручная проверка ещё нужна',
  'observation-only': 'Только наблюдение',
  unsupported: 'Управление не поддерживается',
  unknown: 'Неизвестно',
  fact: 'Факт',
  hypothesis: 'Гипотеза',
